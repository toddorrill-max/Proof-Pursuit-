...
export function installChrome(active){
  ...
  if(header&&!header.querySelector('.near-me')){const action=link('Find near me ↗',active==='index'?'#location-heading':'index.html#location-heading');action.className='near-me';header.append(action);}
