...
try{
 for(const width of [1440,390])for(const route of ['index.html','retailers.html','retailer.html?id=demo-columbus','finding.html?id=sighting-0','store-picks.html','rare-releases.html','methodology.html','about.html','editorial.html']){
 ...
 console.log('PASS: 18 axe scans. Automated results do not replace assistive-technology review.');
